+++
title = "Metopen Kuantitatif - Review Artikel 12"
date = "2025-10-30"
description = "Statistik 2. Korelasi dan Regresi"
...
- Instrumen:
    1. Sistem AI-powered adaptive testing
    2. Sistem pengujian tradisional (kontrol)
    3. Test Anxiety Inventory (TAI)
    4. Pengukuran skor akademik
...
# Hasil/Temuan Utama
- Kinerja Akademik:
    1. Rata-rata skor siswa pada AI-powered adaptive testing (M = 85.4) lebih tinggi dibanding metode tradisional (M = 78.1), perbedaan signifikan (t = 5.32, p < 0.001).
    2. Pengujian adaptif menjelaskan tambahan 20% variansi dalam performa akademik setelah mempertimbangkan variabel kontrol.

- Kecemasan Ujian:
    1. Siswa pada kelompok adaptive testing mengalami penurunan signifikan dalam kecemasan (M = 22.3 → 18.5, t = 4.87, p < 0.001).
    2. Tidak ada perubahan signifikan pada kelompok tradisional (p = 0.144).
    3. Adaptive testing menjelaskan 16% variansi tambahan dalam penurunan kecemasan ujian.

- Faktor-faktor yang Berpengaruh:
    1. Performa akademik sebelumnya (β = 0.35, p < 0.001) dan familiaritas teknologi (β = 0.22, p = 0.002) berkontribusi signifikan terhadap efektivitas pengujian adaptif.
    2. Faktor demografis juga berpengaruh, namun lebih kecil.
...
Gap yang diteliti:
Belum adanya data empiris tentang pengaruh sistem tes adaptif berbasis AI terhadap performa dan kecemasan siswa di konteks negara berkembang seperti Ghana.
